...
VALUES (NULL, '82198127000121', CURRENT_DATE(), CURRENT_DATE(), 'Pontes e Pontes');
...
VALUES (NULL, '16248890935', CURRENT_DATE(), CURRENT_DATE(), 'admin@pontesepontes.com.br', 'ADMIN', 'ROLE_ADMIN', NULL, NULL,
